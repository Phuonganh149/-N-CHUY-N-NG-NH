...
public class mapUsers {
    public static Account mapAccount(ResultSet rs) throws SQLException {
        ...
        AccountRole role = AccountRole.valueOf(rs.getString(ROLE.value()).toUpperCase());
        ...
        AccountStatus status = AccountStatus.valueOf(rs.getString(STATUS.value()).toUpperCase());
        AccountProvider provider = AccountProvider.valueOf(rs.getString(PROVIDER.value()).toUpperCase());
