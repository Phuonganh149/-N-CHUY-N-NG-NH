 ...
 */
@Service
public class SkillService implements CoreEntityServiceInterface<Skill, Integer, SkillPostRequest, SkillPatchRequest> {
     ...
     */
    @Override
    public Skill read(Integer skillId) throws Exception {
     ...
     */
    @Override
    public void update(SkillPatchRequest request, Integer skillId) throws Exception {
     ...
     */
    @Override
    public void delete(Integer skillId) throws Exception {
        try {
