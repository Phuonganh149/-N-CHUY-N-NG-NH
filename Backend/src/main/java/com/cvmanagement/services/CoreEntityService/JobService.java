 ...
 */
@Service
public class JobService implements CoreEntityServiceInterface<Job, Integer, JobPostRequest, JobPatchRequest> {
     ...
     */
    @Override
    public void create(JobPostRequest request) throws Exception {
        Job newJob = new Job();
        try {
            //Validate job title
            ...
            //Validate Location
            boolean found = false;
            for (CompanyLocation elem : CompanyLocation.values()) {
     ...
     */
    @Override
    public Job read(Integer jobId) throws Exception {
        try {
     ...
     */
    @Override
    public void update(JobPatchRequest request, Integer jobId) throws Exception {
        try {
