...
@Service
public class CandidateService implements CoreEntityServiceInterface<Candidate, UUID, SignupAccount, CandidatePatchRequest> {
     ...
     */
    @Override
    public void update(CandidatePatchRequest request, UUID userId) throws Exception {
